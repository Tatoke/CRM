...
async function deleteClient(req, res) {
    ...
    try {
      const result = await db.result('DELETE FROM client WHERE clientid = $1', [id]);
...
export default {getClient, getClientById, addNewClient,getClientCompanyOrderListInfo, deleteClient};